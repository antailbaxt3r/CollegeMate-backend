...
//library
db.public.login.hasMany(db.public.library, {foreignKey: 'login_id',  onDelete: 'CASCADE', constraints: false, allowNull: false})
db.public.library.belongsTo(db.public.login, { foreignKey: 'login_id', onDelete: 'CASCADE', constraints: false, allowNull: false });

//attendance
db.public.login.hasMany(db.public.attendance,  {foreignKey: 'login_id',  onDelete: 'CASCADE', constraints: false, allowNull: false})
